...
Race_SCHOOL_ONLY <- read_excel("~/Desktop/Visualizing DPS/Race SCHOOL ONLY.xlsx")
race <- read_excel("~/Desktop/Visualizing DPS/race.xlsx")
race_diff <- read_excel("~/Desktop/Visualizing DPS/race diff.xlsx")
poc_per_school <- read_excel("~/Desktop/Visualizing DPS/poc per school.xlsx")
funding <- read_excel("~/Desktop/Visualizing DPS/funding.xlsx")
all_race <- read_excel("~/Desktop/Visualizing DPS/all race.xlsx")
schoolstats <- read.csv("~/Desktop/Visualizing DPS/SchoolStats.csv")

#Load Map Data
durham <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Ten Schools.geojson", what = "sp")
cc <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/CC Spaulding.geojson", what = "sp")
eastway <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Eastway.geojson", what = "sp")
ek <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/EK Powe.geojson", what = "sp")
fayetteville <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Fayetteville St.geojson", what = "sp")
forest <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Forest View.geojson", what = "sp")
hillside <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Hillside.geojson", what = "sp")
jordan <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/CEJordan.geojson", what = "sp")
lakewood <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Lakewood.geojson", what = "sp")
parkwood <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Parkwood.geojson", what = "sp")
southwest <- geojsonio::geojson_read("~/Desktop/Visualizing DPS/Southwest.geojson", what = "sp")

#Spatial Data
bus <- read.csv("~/Desktop/Visualizing DPS/renamed_Bus Stops.csv")
childcare <- read.csv("~/Desktop/Visualizing DPS/renamed_Childcare Centers.csv")
cultural <- read.csv("~/Desktop/Visualizing DPS/renamed_Community & Cultural Centers.csv")
gardens <- read.csv("~/Desktop/Visualizing DPS/renamed_Community Gardens.csv")
grocery <- read.csv("~/Desktop/Visualizing DPS/renamed_Grocery Stores.csv") #note what we consider a grocery store, not food desert food apartheid
libraries <- read.csv("~/Desktop/Visualizing DPS/renamed_Libraries.csv")
parks <- read.csv("~/Desktop/Visualizing DPS/renamed_Parks.csv")
rec <- read.csv("~/Desktop/Visualizing DPS/renamed_Recreation Centers.csv")
religious <- read.csv("~/Desktop/Visualizing DPS/renamed_Religious Centers.csv")
